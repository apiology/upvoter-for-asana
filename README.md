...
1. Create a config.js with a variable named 'asanaAccessToken' with a
   new
...
6. Make sure 'Developer mode' is flipped on in the upper right.
7. Click the 'Load unpacked' button.
8. Choose the directory containing this code.
